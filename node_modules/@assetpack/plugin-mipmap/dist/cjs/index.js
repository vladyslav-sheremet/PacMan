...
function mipmap(options) {
    ...
    return {
        ...
        name: 'mipmap',
        test(tree) {
            return core.checkExt(tree.path, '.png', '.jpg', ',jpeg');
        },
        async transform(tree, processor, options) {
            ...
            const resolutionHash = core.hasTag(tree, 'path', tags.fix)
                ? {
...
function spineAtlasMipmap(options) {
    ...
    return {
        ...
        test(tree, _p, opts) {
            ...
            return core.hasTag(tree, 'file', opt.spine) && core.checkExt(tree.path, '.atlas');
        },
        async transform(tree, processor, options) {
            const tags = { ...defaultOptions.tags, ...options.tags };
            const transformOptions = { ...defaultOptions, ...options };
...
exports.spineAtlasMipmap = spineAtlasMipmap;
