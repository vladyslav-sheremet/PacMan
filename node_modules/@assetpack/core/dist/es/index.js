...
class Processor {
    ...
    _onStart = new Runner('start');
    /** A runner that calls the finish function of a plugin */
    _onFinish = new Runner('finish');
...
export { AssetPack, Logger, Processor, SavableAssetCache, checkExt, defaultConfig, hasTag, merge, path, replaceExt };
