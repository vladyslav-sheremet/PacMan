...
class Select extends display.Container {
  constructor({ closedBG, textStyle, items, openBG, selected, selectedTextOffset, scrollBox, visibleItems }) {
    super();
    ...
    const defaultView = new graphics.Graphics().beginFill(0, 1e-5).drawRect(0, 0, this.openButton.width, this.openButton.height);
