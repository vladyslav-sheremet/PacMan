...
import { utils as utils_2 } from '@pixi/core';
 ...
 */
declare class HTMLAudioContext extends utils_2.EventEmitter implements IMediaContext {
 ...
 * @extends PIXI.util.EventEmitter
 */
declare class HTMLAudioInstance extends utils_2.EventEmitter implements IMediaInstance {
 ...
 * @extends PIXI.util.EventEmitter
 */
declare class HTMLAudioMedia extends utils_2.EventEmitter implements IMedia {
    parent: Sound;
    private _source;
 ...
 */
export declare const soundAsset: AssetExtension<any, any>;
 ...
 */
declare class WebAudioInstance extends utils_2.EventEmitter implements IMediaInstance {
    /**
     * The current unique ID for this instance.
     * @readonly
     */
